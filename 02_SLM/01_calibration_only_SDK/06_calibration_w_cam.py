...
sample_num=256
pattern = numpy.ones((height.value*width.value*bytesPerPixel), dtype=numpy.uint8)
slm_array = numpy.empty([sample_num, height.value*width.value*bytesPerPixel], dtype=numpy.uint8)
